...
IMAGE_MODEL = "gemini-3.1-flash-image-preview"  # NanoBanana 2
...
Your capabilities:
- generate_image: Create images with NanoBanana 2 (Gemini 3.1 Flash Image). Use this when asked to generate, create, render, or visualize anything.
