 ...
 * Positioned as a floating panel above the control bar.
 *
...
export function GeneratedImagePanel() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-36 z-40 flex justify-center px-4 md:bottom-44">
